module SRAM_CTRL #(
  ...
  ,parameter RAM_DEPTH = 32'h1000_0000
  ...
  input  [1:0]  io_enq_bits_source, // @[:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256260.4]
  input  [31:0] io_enq_bits_address, // @[:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256260.4]
  input  [RAM_WIDTH/8-1:0]  io_enq_bits_mask, // @[:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256260.4]
  input  [RAM_WIDTH-1:0] io_enq_bits_data, // @[:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256260.4]
  ...
  output [1:0]  io_deq_bits_source, // @[:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256260.4]
  output [31:0] io_deq_bits_address, // @[:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256260.4]
  output [RAM_WIDTH/8-1:0]  io_deq_bits_mask, // @[:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256260.4]
  output [RAM_WIDTH-1:0] io_deq_bits_data, // @[:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256260.4]
  output        io_deq_bits_corrupt // @[:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256260.4]
);
  reg [2:0] _T_35_opcode [0:RAM_DEPTH-1]; // @[Decoupled.scala 214:24:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256262.4]
  reg [31:0] _RAND_0;
  ...
  reg [2:0] _T_35_param [0:RAM_DEPTH-1]; // @[Decoupled.scala 214:24:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256262.4]
  reg [31:0] _RAND_1;
  ...
  reg [2:0] _T_35_size [0:RAM_DEPTH-1]; // @[Decoupled.scala 214:24:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256262.4]
  reg [31:0] _RAND_2;
  ...
  reg [1:0] _T_35_source [0:RAM_DEPTH-1]; // @[Decoupled.scala 214:24:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256262.4]
  reg [31:0] _RAND_3;
  wire [1:0] _T_35_source__T_58_data; // @[Decoupled.scala 214:24:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256262.4]
  ...
  wire [1:0] _T_35_source__T_50_data; // @[Decoupled.scala 214:24:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256262.4]
  ...
  reg [31:0] _T_35_address [0:RAM_DEPTH-1]; // @[Decoupled.scala 214:24:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256262.4]
  reg [31:0] _RAND_4;
  wire [31:0] _T_35_address__T_58_data; // @[Decoupled.scala 214:24:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256262.4]
  ...
  wire [31:0] _T_35_address__T_50_data; // @[Decoupled.scala 214:24:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256262.4]
  ...
  reg [RAM_WIDTH/8-1:0] _T_35_mask [0:RAM_DEPTH-1]; // @[Decoupled.scala 214:24:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256262.4]
  reg [31:0] _RAND_5;
  wire [RAM_WIDTH/8-1:0] _T_35_mask__T_58_data; // @[Decoupled.scala 214:24:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256262.4]
  ...
  wire [RAM_WIDTH/8-1:0] _T_35_mask__T_50_data; // @[Decoupled.scala 214:24:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256262.4]
  ...
  reg [RAM_WIDTH-1:0] _T_35_data [0:RAM_DEPTH-1]; // @[Decoupled.scala 214:24:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256262.4]
  reg [RAM_WIDTH-1:0] _RAND_6;
  wire [RAM_WIDTH-1:0] _T_35_data__T_58_data; // @[Decoupled.scala 214:24:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256262.4]
  ...
  wire [RAM_WIDTH-1:0] _T_35_data__T_50_data; // @[Decoupled.scala 214:24:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256262.4]
  ...
  reg  _T_35_corrupt [0:RAM_DEPTH-1]; // @[Decoupled.scala 214:24:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256262.4]
  reg [31:0] _RAND_7;
  ...
  assign _T_35_data__T_58_data = _T_35_data[_T_35_data__T_58_addr]; // @[Decoupled.scala 214:24:sifive.freedom.unleashed.DevKitU500FPGADesign_WithDevKit50MHz.fir@256262.4]
...
`ifdef RANDOMIZE
  ...
  `ifdef RANDOMIZE_MEM_INIT
  for (initvar = 0; initvar < 2; initvar = initvar+1)
    _T_35_mask[initvar] = _RAND_5[RAM_WIDTH/8-1:0];
  `endif // RANDOMIZE_MEM_INIT
  _RAND_6 = {2{`RANDOM}};
  `ifdef RANDOMIZE_MEM_INIT
  for (initvar = 0; initvar < 2; initvar = initvar+1)
    _T_35_data[initvar] = _RAND_6[RAM_WIDTH-1:0];
  `endif // RANDOMIZE_MEM_INIT
  _RAND_7 = {1{`RANDOM}};
  `ifdef RANDOMIZE_MEM_INIT
  for (initvar = 0; initvar < 2; initvar = initvar+1)
