---
title: "axi_xbar Checklist"
---

This checklist is for [Hardware Stage]({{<relref "/doc/project/development_stages.md" >}})
transitions for the [axi_xbar peripheral.](../) All checklist
...
--------------|--------------------------------|-------------|------------------
Documentation | [SPEC_COMPLETE][]              | Done        | [axi_xbar Spec][]
...
[axi_xbar Spec]:      {{<relref "/_index.md">}}
...
### V1
 ...
 Type         | Item                                  | Resolution      | Note/Collaterals
--------------|---------------------------------------|-----------------|------------------
Documentation | [DV_DOC_DRAFT_COMPLETED][]            | Done            | [axi_xbar DV document]({{<relref "dv/index.md" >}})
Documentation | [TESTPLAN_COMPLETED][]                | Done            | [axi_xbar Testplan]({{<relref "dv/index.md#testplan" >}})
...
Coverage      | [SIM_CODE_COVERAGE_AT_100][]      | Done        | Merge common exclusions then add axi_xbar specifics.
