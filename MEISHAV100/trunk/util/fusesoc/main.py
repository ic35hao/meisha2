...
print("\n***************************************")
print("** IP Manager Use Sys Path: {} **".format(sys.path))
print("***************************************\n")
...
def init_coremanager(config, args_cores_root, build_root, args_resolve_env_vars=False):
    logger.debug("Initializing core manager")
    cm = CoreManager(config, build_root, resolve_env_vars=args_resolve_env_vars)
