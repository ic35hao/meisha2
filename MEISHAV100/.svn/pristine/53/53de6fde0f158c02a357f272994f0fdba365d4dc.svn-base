  ...
  class axi_base_reg_block extends dv_base_reg_block;
    // registers
    rand uart_reg_ctrl ctrl;

    `uvm_object_utils(axi_base_reg_block)

    function new(string name = "axi_base_reg_block",
                 int    has_coverage = UVM_NO_COVERAGE);
