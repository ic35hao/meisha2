...
class axi_base_cfg_update_on_fly_vseq extends axi_base_random_vseq;
  `uvm_object_utils(axi_base_cfg_update_on_fly_vseq)
  `uvm_object_new
...
endclass : axi_base_cfg_update_on_fly_vseq
