...
class tl_agent_cfg extends dv_base_agent_cfg;
  ...
  int unsigned rsp_data_width = 32;   // byte size
  ...
  `uvm_object_utils_begin(tl_agent_cfg)
    ...
    `uvm_field_int(rsp_data_width,     UVM_DEFAULT)
    `uvm_field_int(use_seq_item_a_valid_len,     UVM_DEFAULT)
    `uvm_field_int(allow_a_valid_drop_wo_a_ready,     UVM_DEFAULT)
    `uvm_field_int(use_seq_item_d_valid_len,     UVM_DEFAULT)
    `uvm_field_int(allow_d_valid_drop_wo_d_ready,     UVM_DEFAULT)
