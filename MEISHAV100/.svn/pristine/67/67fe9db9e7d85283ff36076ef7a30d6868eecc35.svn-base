...
package otp_ctrl_part_pkg;
  ...
  parameter logic [16383:0] PartInvDefault = 16384'({
    ...
    // PartInvDefault[PartInfo[k].offset*8 +: PartInfo[k].size*8]
    parameter logic [10:0] DataDefaultValue [NumPart] = '{
      // CREATOR_SW_CFG
      PartInvDefault['d6143:'d0],
      PartInvDefault['d1536*8-1:'d768*8],
      PartInvDefault['d1776*8-1:'d1536*8],
      PartInvDefault['d1816*8-1:'d1776*8],
      PartInvDefault['d1904*8-1:'d1816*8],
      PartInvDefault['d1992*8-1:'d1904*8],
      PartInvDefault['d2048*8-1:'d1992*8]
    };
